...
<CardGroup cols={2}>
  ...
  <Card title="On-Chain Transparency" icon="blockchain">
    70% of the deposited WBTC is held on-chain in a Solana multisig wallet in the form of $JLP. The Solana multisig participants represent geographically distributed key holders that have vast industry experience and contribute actively to DeFi projects and funds.
  </Card>
</CardGroup>
