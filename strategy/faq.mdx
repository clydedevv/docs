...
<AccordionGroup>
  <Accordion title="What is the worst-case scenario if the market crashes?">
    ...
    Even in extreme market conditions, principal protection remains a key focus of the JLP Delta Neutral strategy design.
  </Accordion>

  <Accordion title="How robust is the infrastructure?">
    The JLP Delta Neutral strategy relies on a robust technical infrastructure with multiple redundancies:
