...
description: "Understanding the risks and control mechanisms in the JLP BTC Neutral strategy"
...
<AccordionGroup>
  ...
  <Accordion title="Exchange Risk">
    ...
    **Controls:**
    ...
    - Using Binance and other top tier exchanges for trading operations (proven track record)
