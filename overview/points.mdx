...
| **Strategy** | **Multiplier** |
| --- | --- |
| Minting Vault shares | 1× |
| maxBTC on Neutron (not in DeFi protocols) | 1× |
| LP Vault shares | 10× |
| maxBTC/WBTC supervault | 10× |
| maxBTC as collateral on Amber | 3× |
| maxBTC/USDC supervault | 25× |

<Note>
*Track your points and ranking at [points.structured.money](https://points.structured.money/)*
</Note>
